...
urlpatterns = [
    path('review-subscription/type=<slug:subscription_type>', user_views.review_subscription, name='review_subscription'),
    ...
    path('profile/cancel-subscription', user_views.cancel_subscription, name="cancel_subscription"),
    path('profile/activate-subscription', user_views.reactivate_subscription, name="reactivate_subscription"),
]
